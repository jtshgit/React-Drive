...
{/*                     
                    <div className="note-box">
                        <img className="thumbnail" src="../default-thumb.jpg" />
                        <div className="middle">
                            <center className="view">
                                <img src="../eye.svg" />
                                <span>100.2M</span>
                            ...
                            <div className="note-name">
                                <span>Go through the course content thoroughly and enroll before the batch begins.Go through the course content thoroughly and enroll before the batch begins.Go through the course content thoroughly and enroll before the batch begins.</span>
                            </div></div>
                        <div className="lowerDet">
                            <div className="lower">
                                <img className="userP" src="../user.jpeg" />
                                <div className="naming">
                                    <h4>Salmaan Khan</h4>
